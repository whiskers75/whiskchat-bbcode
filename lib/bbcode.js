...
exports.parse = function(post, cb) {
    ...
    var tagname_re = /^\/?(?:b|i|u|pre|samp|code|colou?r|size|noparse|url|link|s|q|blockquote|me|rcv|img|u?list|li)$/i;
	...
	if(isValidTag(m2)) {
		...
		if (m3) {
			...
			m3 = 100;
                    ...
                    return "<"+m2l+" style='max-width: " + m3 + "%;' src=\"";
		}
		
                return "<"+m2l+" style='max-width: 15%;' src=\"";
