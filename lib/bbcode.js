...
exports.parse = function(post, cb) {
    ...
    var tagname_re = /^\/?(?:b|i|u|pre|samp|code|colou?r|noparse|url|link|s|q|blockquote|octocat|me|rcv|size|img|u?list|li)$/i;
	...
	if(isValidTag(m2)) {
		...
		if (m3) {
            ...
            case "octocat":
                ...
                if (m3) {
                    return "<"+m2l+" style='max-height: " + m3 + "px;' src=\"http://octodex.github.com/images/" + m3 + ".png";
                }
